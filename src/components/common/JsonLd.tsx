...
export function getJsonLd(isArticle: boolean, name: string | undefined, description: string | undefined, url: string | undefined = ""): WithContext<JsonLDArticle | JsonLDWebPage> {
...
export function generateWebsiteStructure(pageMeta: PageMetadata) {
  return <script
    key="json-ld"
    type="application/ld+json"
    dangerouslySetInnerHTML={{ __html: JSON.stringify(getJsonLd(pageMeta.isArticle, pageMeta.title, pageMeta.description, pageMeta.url)) }}
  />
}