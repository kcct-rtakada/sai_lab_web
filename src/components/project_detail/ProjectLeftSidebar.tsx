      ...
      <div className={styles.side_content_area}>
        ...
        <div className={styles.l_index}>
          <ul>
            ...
            {project.abstract ? (
              <li>
                <Link href='#abstract' className={`${styles.link_box} ${styles.h2}`}>
                  Abstract
                </Link>
              </li>
            ) : (
            ...
            {project.posterHTML ? (
              <li>
                <Link href='#poster' className={`${styles.link_box} ${styles.h2}`}>
                  Poster
                </Link>
              </li>
            ) : (
            ...
            {project.presentationHTML ? (
              <li>
                <Link href='#presentation' className={`${styles.link_box} ${styles.h2}`}>
                  Presentation
                </Link>
              </li>
            ) : (
            ...
            {project.documentHTML ? (
              <li>
                <Link href='#document' className={`${styles.link_box} ${styles.h2}`}>
                  Document
                </Link>
              </li>
            ) : (
            ...
            {project.freeHTML ? (
              <li>
                <Link href='#misc' className={`${styles.link_box} ${styles.h2}`}>
                  Misc
                </Link>
              </li>
            ) : (
            ...
            {project.additionalImageURL.length > 0 ? (
              <li>
                <Link href='#images' className={`${styles.link_box} ${styles.h2}`}>
                  Images
                </Link>
              </li>
            ) : (
            ...
            <li>
              <Link href='#information' className={`${styles.link_box} ${styles.h2}`}>
                Information
              </Link>
            </li>
          </ul>
