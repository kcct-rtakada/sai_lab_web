  ...
  const triggerSearchProjects = () => {
    ...
    if (selectedSearchMode === "research_name") {
      filteredArray = projects?.filter((project) =>
        filterKeywords.some(
          (keyword) => keyword !== "" && project.title.includes(keyword)
        )
      );
      ...
      filteredArray = projects?.filter((project) =>
        filterKeywords.some((keyword) =>
          project.authors.some(
            (author) => keyword !== "" && author.name.includes(keyword)
          )
        )
      );
      ...
      filteredArray = projects?.filter((project) =>
        filterKeywords.some((keyword) =>
          project.tags.some(
            (tag) => keyword !== "" && tag.name.includes(keyword)
          )
        )
      );
    }
          ...
          <div className={styles.search_box}>
            <div className={styles.search_area}>
              ...
              <select
                ...
                name="search_type"
              >
                <option value="research_name">研究名</option>
                <option value="research_author">著者</option>
                <option value="research_tag">タグ</option>
              </select>
            </div>
          </div>
